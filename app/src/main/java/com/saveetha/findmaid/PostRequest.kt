...
import com.saveetha.findmaid.server.PostRequestResponse
...
class PostRequest : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        buttonSubmit.setOnClickListener {
            ...
            if (userId == -1 || name.isEmpty() || age.isEmpty() || location.isEmpty() ||
                experience.isEmpty() || phone.isEmpty() || salary.isEmpty() || selectedImageUri == null
            ) {
                Toast.makeText(this, "Please fill all fields and select an image", Toast.LENGTH_SHORT).show()
                return@setOnClickListener
            }

            submitMaidRequest(userId, name, age, location, experience, phone, salary, hours, category)
        }
    }
    ...
    private fun submitMaidRequest(
        userId: Int,
        name: String, age: String, location: String, experience: String,
        phone: String, salary: String, hours: String, category: String
    ) {
        ...
        val call = ApiClient.apiService.uploadMaidDetails(
            userIdPart, namePart, agePart, locationPart, experiencePart,
            phonePart, salaryPart, hoursPart, categoryPart, photoPart
        )

        call.enqueue(object : Callback<PostRequestResponse> {
